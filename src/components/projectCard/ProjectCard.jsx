    ...
    return(
        <>
            <a href={projectUrl} className="hover:scale-[1.02] transition-transform" target="_blank" rel="noopener noreferrer">
                <div className="flex flex-col sm:flex-row gap-4 rounded-md bg-neutral-900 max-w-[550px] p-4">
                    <Image src={`${imageUrl}`} alt="Project Image" sizes="(max-width: 600px) 224px, 600px" className="object-cover rounded-sm max-h-[180px]" width={240} height={240} />
